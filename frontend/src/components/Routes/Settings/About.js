  ...
  return (
    <div className="About">
      ...
      <div className="About-Body">
        ...
        <br />
        <br />
        At Yeti, we are dedicated to cultivating a community that everyone can partake in. We have taken certain steps to ensure that our users feel safe on our platform. These include, but are not limited to: randomly creating usernames for our users, not allowing direct messages, and keeping your information <strong>private</strong> and <strong>secure</strong>.
        <br />
        <br />
